...
import { ct, et } from "../utils/util_CPU";
import { Cre, Role, blocked, calculateForce, cres, damaged, defendInArea, enemies, enemyAWeight, exchangePos, exist, friends, getDamagedRate, getEnemyArmies, getEnemyThreats, getTaunt, hasEnemyThreatAround, hasThreat, isHealer, myUnits, oppo, oppoUnits, setEnRamAroundCost, sumForceByArr } from "../utils/util_Cre";
import { invalid, sum } from "../utils/util_JS";
import { displayPos, inRampart } from "../utils/util_attackable";
import { TB } from "../utils/util_autoBodys";
import { GTB } from "../utils/util_bodyParts";
import { Event, Event_C, validEvent } from "../utils/util_event";
import { SOA } from "../utils/util_export";
import { P, addStrategyTick, strategyTick, tick } from "../utils/util_game";
import { oppoRamparts } from "../utils/util_gameObjectInitialize";
import { findGO } from "../utils/util_overallMap";
import { Dooms, Kerob, Tigga, currentGuessPlayer, getGuessPlayer } from "../utils/util_player";
import { Adj, COO, GR, InShotRan, Pos, X_axisDistance, Y_axisDistance, atPos, getRangePoss, multiplyVector, myGetRange, plusVector } from "../utils/util_pos";
import { findTask } from "../utils/util_task";
import { SA, SAN, drawLineComplex } from "../utils/util_visual";
