...
export function useWormRush_love() {
  const wpn: number = 8;
  ...
  if (st === 0) {
    ...
    //150+640+50
    spawnCreep(TB("3M2R6AM"), wormPart_dooms, new WormInfo(0));
    spawnCreep(TB("4M3A2HM"), wormPart_dooms, new WormInfo(1));
    spawnCreep(TB("9M2R2AM"), wormPart_dooms, new WormInfo(2));
    spawnCreep(TB("9M2R2AM"), wormPart_dooms, new WormInfo(3));
    spawnCreep(TB("9M2R2AM"), wormPart_dooms, new WormInfo(4));
    spawnCreep(TB("9M2R2AM"), wormPart_dooms, new WormInfo(5));
    if (wpn >= 7) {
      if (wpn === 7) {
        if (tailSize === 0) {
