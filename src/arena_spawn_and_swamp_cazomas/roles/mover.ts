...
import { Cre, exist, friends, getFriendArmies, hasMovePart, Role, Task_Cre } from "../utils/Cre";
...
export function getMoverTask(cre: Cre): pullFatigueFriendTask | undefined {
	return <pullFatigueFriendTask>findTaskByFilter(cre, (i: Task) => i instanceof pullFatigueFriendTask);
	//TODO addTask
}
